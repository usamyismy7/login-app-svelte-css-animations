...
<main>
	...
	<form>
		...
		<div class="field">
			<input type={showPassword?"text":"password"} class="input" name="password" placeholder=" " on:input={validatePassword} class:valid={strength>3} />
			<label for="password" class="label">Password</label>
			<span class="toggle-password" on:mouseenter={()=>showPassword=true} on:mouseleave={()=>showPassword=false}>{showPassword?'🙈':'👁️'}</span>
		</div>
		<div class="strength">
